...
namespace GiantBomb.Api
{
    public interface IGiantBombRestClient
    {
        ...
        /// </summary>        
        /// <returns></returns>
        IEnumerable<Platform> GetPlatforms(int page = 1, int pageSize = 20);
        ...
        /// </summary>        
        /// <returns></returns>
        IEnumerable<Game> GetGames(int page = 1, int pageSize = 20);
        ...
        /// <returns></returns>
        IEnumerable<Game> SearchForGames(string query, int page = 1, int pageSize = 20);
        ...
        /// <returns></returns>
        IEnumerable<Game> SearchForAllGames(string query);
    }
}